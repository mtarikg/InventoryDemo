              ...
              return FutureBuilder<PropertyListResponse>(
                ...
                builder: (context, secondSnapshot) {
                  if (secondSnapshot.hasData) {
                    ...
                    String imageURL = secondSnapshot.data!.imageURL.toString();
        ...
        if (snapshot.hasData) {
          return ListView.builder(
            ...
            itemBuilder: (BuildContext context, int index) {
              ...
              return FutureBuilder<PropertyListResponse?>(
                future: PersonnelService()
                    .getPropertyByCategory(propertyID, categoryValue.value),
                builder: (context, secondSnapshot) {
                  ...
                  return const Padding(
                    ...
                    child: Center(child: Text("No property in this category!")),
                  );
                },
              );
            },

...
import 'package:inventory_demo/Models/PersonnelProperty/PersonnelPropertyEditRequest.dart';
...
class _HomePageState extends State<HomePage>
  ...
  @override
  void initState() {
    futurePersonnelProperties = ApiService().getPropertiesOfPersonnel(2, true);
    super.initState();
  }
        ...
        if (snapshot.hasData) {
          return ListView.builder(
            ...
            itemBuilder: (BuildContext context, int index) {
              ...
              DateTime dueOn = DateTime.parse(snapshot.data![index].dueOn);
                            ...
                            children: [
                              ...
                              Row(
                                children: [
                                  IconButton(
                                      onPressed: () {
                                        _rejectPersonnelProperty(2, propertyID);
                                      },
                                      icon: const Icon(Icons.close,
                                          color: Colors.red, size: 50)),
                                  IconButton(
                                      onPressed: () {
                                        _acceptPersonnelProperty(2, propertyID);
                                      },
